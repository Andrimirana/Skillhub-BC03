...
**Corriger tous les bugs existants.** À chaque intervention, identifier et corriger les anomalies rencontrées : bugs fonctionnels, erreurs de configuration, tests cassés, pipeline CI/CD défaillant, problèmes SonarCloud. Ne pas laisser passer un bug connu.
